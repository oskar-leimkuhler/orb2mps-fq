...
atom = """
        ...
        C 0.000000 0.000000 1.087887
        O 1.386054 0.000000 1.441569
        Br 1.569589 0.000000 3.251889
        H -0.501661 -0.892598 1.462312
        H -0.501661 0.892598 1.462312
       """
basis = "sto3g"
# basis = "ccpvtz"
...
E = 200 # Planewave energy cutoff (Hartree)
...
L = 30 # Length of simulation cube (Bohr)
...
# mo_number = 26 # HOMO
mo_number = 27 # LUMO
# mo_number = 40 # A higher-lying unoccupied MO picked for no particular reason, won't work with sto3g.
